...
<head>
    ...
    <title>Halaman Masuk | Buku Tamu</title>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-lg-block bg-primary shadow-lg p-5 text-center">
                                ...
                                <h3 class="text-white">
                                    <br>Sistem Informasi Buku Tamu
                                    <br><small>SMK TELEKOMUNIKASI TELESANDI</small>
                                    <br><small>Bekasi, Jawa Barat</small>
                                </h3>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="https://www.smkstelekomunikasitelesandi.sch.id/">Kec. Tambun Sel., Bekasi | <?= date('d-m-Y') ?></a>
                                    </div>
